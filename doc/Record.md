...
7. `epoll_ctl()` : 将指定的socket对象添加到对应的epoll实例中，以便监听
...
2. epoll_event ： 结构体epoll_event，用于存放某类事件和相关数据
...
- [c++11语法：`auto`的使用](https://zhuanlan.zhihu.com/p/670102303)
  ...
  - 对于某些较长或较奇怪的数据类型，可交给编译器自行推导，这样使代码更简洁
    ...
    */
    ```
- [C++11语法：`std::function`与 `std::bind`](https://zhuanlan.zhihu.com/p/381639427)示例代码
...
[gRPC官方文档](https://protobuf.dev/getting-started/cpptutorial/)
